				...
				<div class="jumbotron form-login">
					...
					<hr class="my-4">
						...
						<div class="form-group">
							<div class="row">
								<label for="email"><?=$data['lbl_Email'] = $this->lang->line('lbl_Email'); ?></label>
								<input type="email" id="email" name="email" class="form-control" placeholder="<?=$data['plh_Email'] = $this->lang->line('plh_Email');?>">
							</div>
						</div>
						<div class="form-group">
							<div class="row">
	...
	<div class="container" style="display: flex; justify-content: center">
        <div class="row">
					<div class="jumbotron col-8">
							...
							<br>
							<br>
							<a href="loginptbr" role="button" class="btn btn-lg btn-primary"	><?=$data['ls_br'] = $this->lang->line('ls_br')?>
							</a>
					</div>
        </div>
    </div>
